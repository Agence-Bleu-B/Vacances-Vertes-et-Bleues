		...
		<header class="row principal"> <!-- header video (balise unique page) -->
			...
			<div class="col-xs-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
			 ...
			 --><nav class="hidden-xs col-sm-8 col-sm-offset-0 col-md-7 col-md-offset-1 vertical-align-item text-right"> <!-- links -->
					  <span class="dropdown">
						  <a href="<?php echo site_url('conseils');?>" class="dropdown-toggle" data-hover="dropdown" data-delay="250" data-close-others="false"><?php echo lang('menu_conseils');?> <b class="caret"></b></a>
