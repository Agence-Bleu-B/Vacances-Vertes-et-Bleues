...
<section id="page">
	<section id="content">
		<div class="container" itemprop="text">
			<h3 class="nannonce">Réservations</h3>
			<h5></h5>
            <ul>
				<li class="conseil_elmt">
                    <h5>Lors des réservations, quelle somme verser ?</h5>
                    ...
                    <h5>La réservation effectuée, a-t-on la possibilité d’annuler ?</h5>
				...
				<li class="conseil_elmt">
					<div class="illust_page">
						<?php echo my_img('conseils/business-money-pink-coins.png','business-money-pink-coins'); ?>	
					</div>
				</li>
			</ul>
            <ul>
            	<li class="conseil_elmt">
					<div class="illust_page">
						<?php echo my_img('conseils/pexels-photo-296886.png','pexels-photo-296886'); ?>	
					</div>
				</li>
				<li class="conseil_elmt">
                    <h5>Avant de prendre possession du logement, faut-il payer une caution ?</h5>
                    ...
                    <h5>Une fois sur place, est-il nécessaire de rédiger un état des lieux ?</h5>
