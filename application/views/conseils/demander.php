	...
	<section id="conseils" itemprop="text">
		<div class="col-xs-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
		 ...
		 --><div class="col-xs-8 col-xs-offset-2 col-md-6 col-md-offset-0 vertical-align-item">
					<?php echo my_img('conseils/ilsnkt1imxe-mari-helin-tuominen.jpg','','img-responsive center-block'); ?>
				</div>
			</div>
			<br>
			<div class="row">
				<div class="col-xs-8 col-xs-offset-2 col-md-6 col-md-offset-0 vertical-align-item hidden-xs hidden-sm">
					<?php echo my_img('conseils/vacation-homes-1209538-1920.jpg','','img-responsive center-block'); ?>
				</div><!--
		 --><p class="col-xs-12 col-md-6 text-justify vertical-align-item">
