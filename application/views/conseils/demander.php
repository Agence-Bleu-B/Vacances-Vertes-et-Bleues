...
<section id="page">
	<section id="content">
		<div class="container" itemprop="text">
			<h3 class="nannonce">Vous devez demander</h3>
            ...
            <ul>														   
				...
				<li class="conseil_elmt">
					<div class="illust_page">						
						<?php echo img('conseils/ilsnkt1imxe-mari-helin-tuominen.jpg','tuominen'); ?>	
					</div>				
				</li>
			</ul>
            <ul>
